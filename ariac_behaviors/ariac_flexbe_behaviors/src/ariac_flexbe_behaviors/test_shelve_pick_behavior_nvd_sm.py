...
'''
class Test_shelvepick_behavior_nvdSM(Behavior):
	'''
	behavior om blauwe gear te pakken te testen
	'''


	def __init__(self):
		super(Test_shelvepick_behavior_nvdSM, self).__init__()
		self.name = 'Test_shelve pick_behavior_nvd'
		...
		self.add_behavior(move_home_pickSM, 'move_home_pick_2')
	...
	def create(self):
		...
		_state_machine.userdata.part_type = 'gasket_part_red'
		...
		with _state_machine:
			...
			OperatableStateMachine.add('move_gantry_bin_gr1_2_2',
										SrdfStateToMoveitAriac(),
										transitions={'reached': 'move_home_pick_2', 'planning_failed': 'failed', 'control_failed': 'failed', 'param_error': 'failed'},
										autonomy={'reached': Autonomy.Off, 'planning_failed': Autonomy.Off, 'control_failed': Autonomy.Off, 'param_error': Autonomy.Off},
			...
			# x:260 y:651
			OperatableStateMachine.add('move_home_pick_2',
										self.use_behavior(move_home_pickSM, 'move_home_pick_2'),
