...
'''
class move_home_pickSM(Behavior):
	'''
	Moves complete gantry to home position above the belt for picking
	'''


	def __init__(self):
		super(move_home_pickSM, self).__init__()
		self.name = 'move_home_pick'
	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('MoveGantryHome',
										...
										transitions={'reached': 'MoveLeftArm', 'planning_failed': 'failed', 'control_failed': 'failed', 'param_error': 'failed'},
