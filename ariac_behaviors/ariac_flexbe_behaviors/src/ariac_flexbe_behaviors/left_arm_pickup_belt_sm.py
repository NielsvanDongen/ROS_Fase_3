...
'''
class left_arm_pickup_beltSM(Behavior):
	'''
	This behavior is used for picking up products from the belt
	'''


	def __init__(self):
		super(left_arm_pickup_beltSM, self).__init__()
		self.name = 'left_arm_pickup_belt'
	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('MovePreGraspBeltRight',
										...
										remapping={'config_name': 'config_name_left_home', 'move_group': 'move_group_left', 'move_group_prefix': 'move_group_prefix', 'action_topic': 'action_topic', 'robot_name': 'robot_name', 'config_name_out': 'config_name_out', 'move_group_out': 'move_group_out', 'robot_name_out': 'robot_name_out', 'action_topic_out': 'action_topic_out', 'joint_values': 'joint_values', 'joint_names': 'joint_names'})
			...
			OperatableStateMachine.add('ComputeGraspRight',
										...
										remapping={'move_group': 'move_group_left', 'move_group_prefix': 'move_group_prefix', 'tool_link': 'tool_link', 'pose': 'pose', 'offset': 'part_offset', 'rotation': 'rotation', 'joint_values': 'joint_values', 'joint_names': 'joint_names'})
