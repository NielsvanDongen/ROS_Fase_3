...
'''
class inspect_arm_part_type_leftSM(Behavior):
	'''
	...
	def __init__(self):
		super(inspect_arm_part_type_leftSM, self).__init__()
		self.name = 'inspect_arm_part_type_left'
	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('CheckRobot1',
										...
										remapping={'value_a': 'part_type_left', 'value_b': 'piston_part'})
